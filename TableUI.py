...
class Ui_MainWindow1(object):
    def setupUi(self, MainWindow1):
        ...
        self.txtCardIDCarLog = QtWidgets.QLineEdit(self.wgCarLog)
        self.txtCardIDCarLog.setGeometry(QtCore.QRect(220, 60, 311, 41))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.txtCardIDCarLog.setFont(font)
        self.txtCardIDCarLog.setReadOnly(True)
        self.txtCardIDCarLog.setObjectName("txtCardIDCarLog")
        ...
        self.tblCarLog.setColumnCount(5)
        ...
        self.tblCarLog.horizontalHeader().setStretchLastSection(True)
        ...
        self.txtCarLicenseCarLog = QtWidgets.QLineEdit(self.wgCarLog)
        self.txtCarLicenseCarLog.setGeometry(QtCore.QRect(220, 180, 311, 41))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.txtCarLicenseCarLog.setFont(font)
        self.txtCarLicenseCarLog.setReadOnly(True)
        self.txtCarLicenseCarLog.setObjectName("txtCarLicenseCarLog")
        self.lblCarLogType_2 = QtWidgets.QLabel(self.wgCarLog)
        self.lblCarLogType_2.setGeometry(QtCore.QRect(10, 240, 201, 41))
        self.lblCarLogType_2.setObjectName("lblCarLogType_2")
        self.cbCarLogCustomer = QtWidgets.QComboBox(self.wgCarLog)
        self.cbCarLogCustomer.setEnabled(False)
        self.cbCarLogCustomer.setGeometry(QtCore.QRect(220, 240, 161, 41))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.cbCarLogCustomer.setFont(font)
        self.cbCarLogCustomer.setEditable(True)
        self.cbCarLogCustomer.setObjectName("cbCarLogCustomer")
        self.cbCarLogCustomer.addItem("")
        self.cbCarLogCustomer.addItem("")
        ...
        self.tblGuest.horizontalHeader().setStretchLastSection(True)
        self.btnLoadDataGuest = QtWidgets.QPushButton(self.wgCard)
        self.btnLoadDataGuest.setGeometry(QtCore.QRect(140, 210, 93, 41))
        ...
        self.txtSearchCardId.setGeometry(QtCore.QRect(140, 140, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.txtSearchCardId.setFont(font)
        self.txtSearchCardId.setReadOnly(False)
        self.txtSearchCardId.setPlaceholderText("")
        self.txtSearchCardId.setObjectName("txtSearchCardId")
        self.btnGuestRegisDisable = QtWidgets.QPushButton(self.wgCard)
        self.btnGuestRegisDisable.setGeometry(QtCore.QRect(400, 70, 211, 41))
        self.btnGuestRegisDisable.setProperty("readOnly", False)
        ...
        self.tblCustomerRegis.horizontalHeader().setStretchLastSection(True)
        ...
        self.btnCustomerRegisOK.setGeometry(QtCore.QRect(560, 110, 93, 41))
        ...
        self.btnCustomerRegisCancel.setGeometry(QtCore.QRect(680, 110, 93, 41))
        ...
        self.btnLoadDataCustomerRegis.setGeometry(QtCore.QRect(610, 160, 93, 41))
        ...
        self.txtSearchCustomer.setPlaceholderText("")
        ...
        self.tblCustomer.setColumnCount(6)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tblCustomer.setHorizontalHeaderItem(5, item)
        self.tblCustomer.horizontalHeader().setStretchLastSection(True)
    ...
    def retranslateUi(self, MainWindow1):
        ...
        item.setText(_translate("MainWindow1", "Customer"))
        self.lblCarLogCarNumber.setText(_translate("MainWindow1", "Card ID"))
        ...
        self.lblCarLogType_2.setText(_translate("MainWindow1", "Customer"))
        self.cbCarLogCustomer.setCurrentText(_translate("MainWindow1", "No"))
        self.cbCarLogCustomer.setItemText(0, _translate("MainWindow1", "No"))
        self.cbCarLogCustomer.setItemText(1, _translate("MainWindow1", "Yes"))
        ...
        self.txtSearchCardId.setToolTip(_translate("MainWindow1", "Search Card Id or Car License"))
        self.btnGuestRegisDisable.setText(_translate("MainWindow1", "Disable"))
        self.btnGuestRegisDisable.setProperty("placeholderText", _translate("MainWindow1", "Search Card ID"))
        ...
        self.txtSearchCustomer.setToolTip(_translate("MainWindow1", "Search by Customer Id or Card Id"))
        ...
        item.setText(_translate("MainWindow1", "Active"))
        item = self.tblCustomer.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow1", "Created Date"))
